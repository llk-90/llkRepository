		...
		<div id="page-content" class="clearfix">
			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					...
					<!-- 检索  -->
					<form action="videoMessage/goVideoMessage.do" method="post"
						name="userForm" id="userForm">
						<table>
							<tr>
								<td><span class="input-icon"> <input
										autocomplete="off" id="nav-search-input" type="text"
										name="USERNAME" value="${pd.USERNAME }" placeholder="这里输入监控名称" />
								...
								<td><input class="span10 date-picker" name="lastLoginStart"
									...
									style="width: 150px;" placeholder="日期" title="" /></td>
								<c:if test="${QX.cha == 1 }">
						...
						<table id="table_report"
							...
							<thead>
								<tr>
									...
									<th>所属大棚</th>
									<th>所属农场</th>
									<th><i class="icon-time hidden-phone"></i>工作状态</th>
							...
							<tbody>
								<tr>
									...
									<td>葡萄棚1号</td>
									<td>A农场</td>
									<td><font color="green">正在运行</font></td>
							...
							<tr>
								...
								<td style="width: 60px;">
									<div class='hidden-phone visible-desktop btn-group'>
										...
										<a class='btn btn-mini btn-warning' title="" onclick="sendSms('${user.PHONE }');"><i class='icon-envelope'></i></a>
										</c:if>
...
// 		}
		...
		function add(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增";
			 diag.URL = '<%=basePath%>videoMessage/addVideoMessage.do';
			 diag.Width = 800;
			 diag.Height = 280;
			 diag.CancelEvent = function(){ //关闭事件
	...
	<script type="text/javascript">
		...
		function toExcel(){
			...
			window.location.href='<%=basePath%>user/excel.do?USERNAME='
					+ USERNAME + '&lastLoginStart=' + lastLoginStart
					+ '&lastLoginEnd=' + lastLoginEnd + '&ROLE_ID=' + ROLE_ID;
		}
