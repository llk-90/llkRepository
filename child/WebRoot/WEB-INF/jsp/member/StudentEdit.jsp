...
<script type="text/javascript">
		...
		function save(){
			...
			if($("#PHONE").val()==""){
			 ...
			 if(!userForm.PHONE.value.match(/^(13[0-9]|15[0-9]|18[0-9])\d{8}$/)){
				 $("#PHONE").tips({
							side : 3,
							msg : "请输入11位的手机号",
							bg : '#FF5080',
...
<body>
	...
	<form action="<%=basePath%>member/edit.do" name="userForm" id="userForm" method="post">
		<input type="hidden" name="s_id" id="s_id" value="${stuInfo.s_id}" /> <input type="hidden" name="s_zone_id" id="s_zone_id" value="${stuInfo.s_zone_id}" /> <input type="hidden" name="USER_ID" id="USER_ID" value="${stuInfo.USER_ID}" /> <input type="hidden" name="editPass" id="editPass" value="no" />
		<div id="zhongxin">
			<table class="table ">
				<tr>
					<td style="width: 80px; text-align: left; padding-top: 13px;">学生学号：</td>
					<td>
						<input type="text" name="s_stu_no" id="s_stu_no" value="${stuInfo.s_stu_no}" onkeyup="this.value=this.value.replace(/\D/g,'')" placeholder="这里输入学生学号" maxlength="32" title="学生学号" />
					</td>
					<td style="width: 80px; text-align: left; padding-top: 13px;">所属班级：</td>
					<td>
						<input type="text" id="citySel" style="width: 208px;" disabled="disabled" value="${stuInfo.className}">
					</td>
				</tr>
				<tr>
					<td style="width: 80px; text-align: left; padding-top: 13px;">学生姓名：</td>
					<td>
						<input type="text" name="s_name" id="s_name" value="${stuInfo.s_name}" placeholder="这里输入学生姓名" maxlength="32" title="学生姓名" />
					</td>
					...
					<td>
						<select class="chzn-select" name="s_sex" id="s_sex" data-placeholder="请选择学生性别" style="vertical-align: top;" onchange="tips();">
							<option value=""></option>
							<option value="0" <c:if test="${stuInfo.s_sex  == '0' }">selected = "true"</c:if>>女</option>
							<option value="1" <c:if test="${stuInfo.s_sex  == '1' }">selected = "true"</c:if>>男</option>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="NAME" id="NAME" value="${stuInfo.NAME}" placeholder="这里输入学生家长" maxlength="32" title="学生家长" />
					</td>
					<td style="width: 80px; text-align: left; padding-top: 13px;">家长电话：</td>
					<td>
						<input type="text" name="PHONE" id="PHONE" value="${stuInfo.PHONE}" onkeyup="this.value=this.value.replace(/\D/g,'')" class="gbkOrAbc" placeholder="这里输入家长电话" maxlength="32" title="家长电话" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input type="text" name="EMAIL" id="EMAIL" value="${stuInfo.EMAIL}" placeholder="这里输入家长邮箱" maxlength="32" title="家长邮箱" />
					</td>
				<tr>
