...
<body  onUnload="opener.location.reload()">
				...
				<tr>
					...
					<td>
						<select name="Type" id="Type" style="width: 100px;">
							<option value="0">学校介绍</option>
							<option value="1">校园资讯</option>
							<option value="2">校园风采</option>
							<option value="3">学生活动</option>
							<option value="4">教师风采</option>
							<option value="5">招生信息</option>
							<option value="6">家庭教育</option>
						</select>
					</td>
				</tr>
				<tr>
	...
	<script type="text/javascript">
        ...
        editor.customConfig.uploadImgServer = '/microCampusManage/upfile';
        editor.create();
