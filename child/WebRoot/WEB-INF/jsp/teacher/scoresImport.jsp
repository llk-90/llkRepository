	...
	<head>
		...
		<script type="text/javascript">
			...
			function ajaxFileUpload(){
				...
				if (isError) {
					$.ajaxFileUpload ({
						 url: '<%=basePath%>scoresImportController/readExcel.do',
					     secureuri:false, 
					     fileElementId:'excel',
					     dataType:'text',
						 autoSubmit: true,
			             ...
			             data = data.replace("</pre>", ''); 
						 if (data == "success"){
					            $("#Form1").attr("action", '<%=basePath%>scoresImportController/returnScore.do');
			                    $("#Form1").submit();
								$("#zhongxin").hide();
								$("#zhongxin2").show(); 
						 } else {	
		...
		<table style="width:95%;" >
			...
			<tr style="">
				<td style="text-align: center; ">
					...
					<a style="margin-top: 20px;" class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/scoresImportController/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
