	...
	<form  action="dictionaries/save.do" name="Form" id="Form" method="post" >
		...
		<div id="zhongxin">
			<table  class="table ">
				...
				<tr class="info">
					<td style="width: 80px; text-align: left; padding-top: 13px;">名称：</td>
					<td><input type="text" name="NAME" id="NAME"
						placeholder="这里输入名称" value="${pd.NAME }" title="名称" /></td>
				</tr>
				<tr class="info">
					<td style="width: 80px; text-align: left; padding-top: 13px;">编码：</td>
					<td><input type="text" name="BIANMA" id="BIANMA"
						placeholder="这里输入编码" value="${pd.BIANMA }" title="编码" /></td>
				</tr>
				<tr class="info">
					<td style="width: 80px; text-align: left; padding-top: 13px;">序号：</td>
					<td><input type="number" name="ORDY_BY" id="ORDY_BY"
						placeholder="这里输入序号" value="${pd.ORDY_BY}" title="序号" /></td>
				</tr>
				<tr>
