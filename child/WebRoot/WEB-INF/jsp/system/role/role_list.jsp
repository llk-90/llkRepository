  ...
  <div class="row-fluid">
	...
	<%-- <div id="breadcrumbs">
		<table class="center" style="width:100%;">
			<tr height="35">
					<!-- <td style="width:100px;" class="center btn-success" >
						<a href="javascript:addRole();"><li class=" icon-plus" style="color:#FFF"></li>&nbsp;<font color="#FFF">添加组</font></a>
					</td>
		...
		<table>
			...
			<td>
			<a class="btn btn-mini btn-info" onclick="editRole('${pd.ROLE_ID }');">修改组名称</a>
				<c:choose>
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<c:choose>
			<c:when test="${not empty roleList_z}">
				...
				<td style="width:155px;" class="center">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function delZhu(role_id,role_name){
