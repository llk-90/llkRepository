...
<script type="text/javascript">
	...
	function save(){	
        ...
        $("#msg").focus();
        	...
        	top.jzts();
			$('#Form').attr('action', 'coursewareP/save.do');
			$('#Form').submit();
		}
	}
	//返回
				...
				<div class="row-fluid">
					<form action="" name="Form" id="Form" method="post" >
						<div id="zhongxin">
							...
							<br>
							<div class="row-fuild form-inline" style="margin-top: 10px;">
								<label class="lbl" style="margin-bottom: 0px;" for="repair_title">所属年级：</label> <select class="chzn-select" name="c_grade" id="c_grade" data-placeholder="请选择所属年级" style="width: 250px; vertical-align: top;" onchange="tips();">
									<option value=""></option>
									<c:forEach var="item" items="${grade}">
										<option value="${item.key}">${item.value}</option>
									</c:forEach>
								</select> <label class="lbl" style="margin-bottom: 0px;" for="repair_title">所属权限：</label> <select class="chzn-select" name="c_commodity_id" id="c_commodity_id" data-placeholder="请选择所属权限" style="width: 250px; vertical-align: top;" onchange="tips();">
									<option value=""></option>
							...
							<div class="row-fuild form-inline">
								<label class="lbl" for="">课件标题：</label> <input
									maxlength="32" type="text" id="c_name"
									name="c_name"  style="width: 530px" title="课件标题" placeholder="这里输入课件标题" />
							</div>
							<br>
							<div class="row-fuild" id="msg" style="margin-top: 20px;">
								<label class="lbl" style="margin-bottom: 0px;">详细描述：&nbsp;&nbsp;</label>
								<textarea id="context" name="c_detail" style="min-height: 250px; margin: 0 auto;" title="详细描述"></textarea>
							</div>
						</div>
						<br>
