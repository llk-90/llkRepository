...
<body>
	...
	<form action="classesManage/save.do" name="classForm" id="classForm" method="post">
	  <input type="hidden" id="userId" name= "userId" value= "${pd.userId }"/>
		<div id="zhongxin">
			<table class="table ">
			    <tr>
			        <td style="width: 80px; text-align: left; padding-top: 13px;">年级名称：</td>
					<td>
						<input type="text" name="gradeName" id="gradeName" class='gbkOrName' placeholder="请输入年级名称" maxlength="32" title="年级名称" />
					</td>
			    </tr>
			    
			    <tr>
				    <td style="width: 80px; text-align: left; padding-top: 13px;">班级名称：</td>
						<td>
							<input type="text" name="className" id="className"  placeholder="请设输入学校名称" maxlength="32" title="学校名称 " />
					</td>
			    </tr>
				<tr>
