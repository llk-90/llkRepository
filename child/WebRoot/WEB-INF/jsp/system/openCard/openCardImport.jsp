	...
	<head>
		...
		<script type="text/javascript">
			...
			function ajaxFileUpload(){
				...
				if (isError) {
					$.ajaxFileUpload ({
						 url: '<%=basePath%>stuOpenCard/readExcel.do',
					     secureuri:false, 
					     fileElementId:'excel',
					     dataType:'text',
					     type: 'post',
							...
							bootbox.dialog("导入成功。", 							 
							  {
								...
								"callback": function() {
									$("#Form1").attr("action", '<%=basePath%>stuOpenCard/returnMember.do');
				                    $("#Form1").submit();
									$("#zhongxin").hide();
									$("#zhongxin2").show();
								 }
		...
		<table style="width:95%;" >
			...
			<tr style="">
				<td style="text-align: center; ">
					...
					<a style="margin-top: 20px;" class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/stuOpenCard/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>
