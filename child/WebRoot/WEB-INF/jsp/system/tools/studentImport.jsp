...
<script type="text/javascript">
			...
			function ajaxFileUpload(){
				...
				if (isError) {
					$.ajaxFileUpload ({
						 url: '<%=basePath%>StudentManager/readExcel.do',
				secureuri : false,
				fileElementId : 'excel',
				dataType : 'text',
				autoSubmit : true,
		...
		<table style="width: 95%;">
			...
			<tr style="">
				<td style="text-align: center;">
					...
					<a style="margin-top: 20px;" class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/StudentManager/downExcel.do'">下载模版</a>
				</td>
			</tr>
		</table>
