					...
					<table class="table ">
						<tr>
							<td><label class="control-label"
								style="padding-top: 8px; width: 100px; float: right;" for="name">区&#12288;&#12288;域：</label></td>
							<td><input type="text" class="gbkOrName" maxlength="12"
								placeholder="请输入区域" title="区域" /></td>
						</tr>
						<tr>
							<td><label class="control-label"
								style="padding-top: 8px; width: 100px; float: right;" for="name">经理姓名：</label></td>
						...
						<tr style="display: none">
							<td><label class="control-label"
								style="padding-top: 8px; width: 100px; float: right;" for="name">职&#12288;&#12288;位：</label></td>
						...
						<tr>
							...
							<td><input type="text" name="BZ" id="BZ" value="${pd.BZ}"
								placeholder="请输入备注" maxlength="64" title="备注" /></td>
						</tr>
						<tr>
