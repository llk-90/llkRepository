		...
		<div id="myTabContent" class="tab-content" style="border: 0px; margin-top: 0px">
			<div class="tab-pane fade in active" id="home">
				<form action="areaManager/${msg }.do" name="Form" id="Form" method="post">
					...
					<input type="hidden" name="Z_ID" id="Z_ID" value="${pd.z_id}" />
					<table class="table table-striped table-bordered table-hover">
						<tr>
							<td style="width: 70px; text-align: left; padding-top: 13px;">区&#12288;&#12288;域：</td>
							<td>
								<input type="text" name="AREA" id="AREA" value="${pd.z_name}" maxlength="32" placeholder="这里输入区域" title="密码" />
							</td>
						</tr>
						<tr>
