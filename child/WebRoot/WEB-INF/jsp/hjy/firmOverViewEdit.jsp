			...
			<table class="table">
				...
				<tr>
					...
					<select name="firm_area"
						id="firm_area" class="chzn-select" style="width: 110px;"
						data-placeholder="请选择城市">
						 <option value="" selected="selected"></option>
							<c:forEach items="${areaList }" var="area" varStatus="vs">
								<option value="${area.CityName}" 
								<c:if test="${area.CityName eq firmOverView.area }">selected="selected"</c:if>
								>${area.CityName}</option>
							</c:forEach>
					</select>
