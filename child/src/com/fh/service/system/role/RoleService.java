...
public class RoleService{
	...
	public List<Role> listAllapERRoles() throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listAllapERRoles", null);
	...
	* 通过rolename获取数据
	*/
	public PageData findByRId(PageData pd)throws Exception{
		return (PageData)dao.findForObject("RoleMapper.findByRId", pd);
	}
	...
	public List<Role> listAllRolesByPId(Page page) throws Exception {
		return (List<Role>) dao.findForList("RoleMapper.listPageAllRolesByPId", page);
