...
public class AppuserService {
	...
	*/
	public PageData findByName(PageData pd)throws Exception{
		return (PageData)dao.findForObject("AppuserMapper.findByName", pd);
	}
	...
	* 通过编号获取数据
	*/
	public PageData findByPH(PageData pd)throws Exception{
		return (PageData)dao.findForObject("AppuserMapper.findByPH", pd);
	}
