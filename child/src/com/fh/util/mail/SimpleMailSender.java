...
public class SimpleMailSender extends BaseController {
	 ...
	 * @throws Exception
	 */
	public static void sendEmails(String SMTP, String PORT, String EMAIL, String PAW, String toEMAIL, String TITLE,
			String CONTENT, String TYPE) throws Exception {
		...
		transport.connect(SMTP, EMAIL, PAW);
	...
	public static void main(String[] args) throws Exception {
		...
		sendEmails(Const.SMTP, Const.PORT, Const.EMAIL, Const.PAW, "260942835@qq.com", "嘎嘣脆", "嘎嘣脆", "2");
	}
	 ...
	 * @throws Exception
	 */
	public static boolean sendmail(String name, String pass, String Email) throws Exception {
		MailSenderInfo mailInfo = new MailSenderInfo();
		mailInfo.setMailServerHost(Const.SMTP);
		mailInfo.setMailServerPort(Const.PORT);
		mailInfo.setValidate(true);
		mailInfo.setUserName(Const.EMAIL);
		mailInfo.setPassword(Const.PAW);
		mailInfo.setFromAddress(Const.EMAIL);
		mailInfo.setToAddress(Const.EMAIL);
		mailInfo.setSubject("注册成功！");
		mailInfo.setContent("您的用户名为" + name + "，您的密码为" + pass + "。");
		SimpleMailSender sms = new SimpleMailSender();
		sms.sendTextMail(mailInfo);
		return true;
	}
