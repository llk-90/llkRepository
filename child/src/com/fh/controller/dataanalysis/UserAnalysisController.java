...
import com.fh.service.dataanalysis.UserAnlysisService;
import com.fh.util.Const;
import com.fh.util.PageData;
import com.fh.util.Tools;

@Controller
@RequestMapping(value = "/userAnalysisController")
public class UserAnalysisController extends BaseController {
	String menuUrl = "userAnalysisController/list.do"; // 菜单地址(权限用)

	@Resource(name="userAnlysisService")
	private UserAnlysisService userAnlysisService;
	...
	public Map<String, Object> listData() throws Exception {
		...
		map = userAnlysisService.list(pd);
		return map;
	}
	...
	public void excel(Page page, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			List<PageData> alllist  = (List<PageData>) userAnlysisService.list(pd).get("list");
