...
public class SchoolManagerController extends BaseController {
	...
	String menuUrl = "schoolManager/list.do"; // 菜单地址(权限用)
	@Resource(name = "chargehandManagerService")
	private ChargehandManagerService chargehandManagerService;
	private static String TYPE="6";//学校管理员
	private static String ROLE_CODE="XXGL";//角色
	/**
	 * 新增
	 */
	...
	public ModelAndView save() {
		...
		try {
			...
			SimpleMailSender.sendEmails(Const.SMTP, Const.PORT, Const.EMAIL, Const.PAW, pd.getString("EMAIL"), "掌上关爱学校管理员帐号",
	...
	public ModelAndView list(Page page) {
		...
		try {
			...
			mv.setViewName("system/teacher/schoolManager_list");
	...
	public ModelAndView goAdd() {
		...
		try {
			...
			List<PageData> schoolList = chargehandManagerService.findSchoolList(pd);
			mv.setViewName("system/teacher/schoolManager_add");
	...
	public ModelAndView goEdit() {
		...
		try {
			...
			mv.setViewName("system/teacher/schoolManager_edit");
