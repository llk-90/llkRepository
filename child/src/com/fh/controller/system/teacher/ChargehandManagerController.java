 ...
 */
@Controller
@RequestMapping(value = "/chargehandManager")
public class ChargehandManagerController extends BaseController {

	String menuUrl = "chargehandManager/list.do"; // 菜单地址(权限用)
	@Resource(name = "chargehandManagerService")
	private ChargehandManagerService chargehandManagerService;
	private static String TYPE="4";//组长
	private static String ROLE_CODE="ZZ";//角色
	/**
	 * 新增
	 */
	...
	public ModelAndView save() {
		...
		try {
			...
			SimpleMailSender.sendEmails(Const.SMTP, Const.PORT, Const.EMAIL, Const.PAW, pd.getString("EMAIL"), "掌上关爱组长帐号",
	...
	public ModelAndView list(Page page) {
		...
		try {
			...
			mv.setViewName("system/teacher/chargehandManager_list");
	...
	public ModelAndView goAdd() {
		...
		try {
			...
			mv.setViewName("system/teacher/chargehandManager_add");
	...
	public ModelAndView goEdit() {
		...
		try {
			...
			mv.setViewName("system/teacher/chargehandManager_edit");
