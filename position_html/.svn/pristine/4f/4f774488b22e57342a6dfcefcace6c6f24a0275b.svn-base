...
function() {
	...
	function(a, b, c, d) {
		...
		a.createMask = function(b) {
			...
			d2.style.width='140px';
			d2.style.height='100px';
			d2.style.position='absolute';
			d2.style.left='50%';
			d2.style.top='50%';
			d2.style.padding = '10px';
			d2.style.margin='-150px 0 0 -70px';
			//d2.style.backgroundColor = '#2c2b2b';
			d2.classList.add('mui-backdrop-child');
			var imgsss = document.createElement("img");
			imgsss.src ='/palmcare/images/jzx.gif';
			imgsss.style.backgroundColor = 'transparent';
			imgsss.style.width = '50px';
			var s = document.createElement("span");
			var br = document.createElement("br");
			s.innerHTML = '&nbsp;&nbsp;加载中...';
			s.style.color = 'white';
			d2.appendChild(imgsss);
			d2.appendChild(br);
			d2.appendChild(s);
			d.appendChild(d2);
			d.classList.add(h);
